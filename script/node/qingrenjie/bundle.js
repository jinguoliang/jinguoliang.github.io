...
var PassDoor = React.createClass({
  ...
  askPass: function askPass(success) {
  ...
  render: function render() {
    ...
    return React.createElement(
      'div',
      { className: 'door' },
      React.createElement('div', { className: this.state.doorLeftClassName }),
      React.createElement('div', { className: this.state.doorRightClassName }),
      React.createElement('img', { className: this.state.taijiClassName, onClick: this.onClick })
    );
  }
});
...
var Content = React.createClass({
  ...
  getInitialState: function getInitialState() {
    ...
    return {
      currentContent: '',
      content: "  亲爱的小土土同学，作为仙女宝宝，<br>" + "你融美貌与机智于一身。<br>你像一片轻柔的云在我眼前飘来飘去，<br>你清丽秀雅的脸" + "上荡漾着春天般美丽的笑容。 <br>在你那双又大又亮的眼睛里， <br>我总能捕捉到" + "你的宁静，<br>你的热烈， <br>你的聪颖， <br>你的敏感。 ",
      charIndex: -1,
      stringLength: 0,
      spanStyle: 'blink',
  ...
  componentWillUnmount: function componentWillUnmount() {
    console.log("the stay = " + (new Date().getTime() - this.state.start.getTime()));
  ...
  render: function render() {
    ...
    return React.createElement('div', { className: 'typeText', dangerouslySetInnerHTML: { __html: str } });
  }
});

ReactDOM.render(React.createElement(PassDoor, null), document.getElementById('door'));

},{"firebase":2,"react":159,"react-dom":3}],2:[function(require,module,exports){
